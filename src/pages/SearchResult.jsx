...
function SearchResult() {
  ...
  const [onFP,setOnFP]=useState(true)
    useEffect(()=>{
      ...
      fecth()
    },[pageSize,sortBy,sortOrder,onFP,pageNumber,query])
  ...
  return (
   ...
   <nav aria-label="breadcrumb" className="breadcrumb-nav">
     <ol className="breadcrumb">
       ...
       <li className="breadcrumb-item"><a>Tìm kiếm</a></li>
       {/* <Rating  onChange={(e) => console.log(e.value)} cancel={false} /> */}
     </ol>
   </nav>
   <div className="row">
           ...
           <div className="toolbox-left">
             ...
             <div className="toolbox-item toolbox-sort">
               ...
               <div style={{ display:'flex' }}>
                 <p style={{ display:'inline-block',fontSize:18 }}>Tìm thấy: <strong>{totalCount}</strong> sản phẩm cho từ khóa "{query}"</p>
               </div>
             </div>
           </div>
