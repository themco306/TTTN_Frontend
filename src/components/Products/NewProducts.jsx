...
function NewProducts() {
  ...
  <div className="container">
    ...
    <div className="banner banner-big-sale "  style={{background: '#2A95CB center/cover url("assets/images/demoes/demo4/banners/banner-4.jpg")'}}>
      <div className="banner-content row align-items-center mx-0">
        <div className="col-md-9 col-sm-8">
          <h2 className="text-white text-uppercase text-center text-sm-left ls-n-20 mb-md-0 px-4">
            <b className="d-inline-block mr-3 mb-1 mb-md-0">Giảm giá lớn</b> Có thể lên đến 50%
            <small className="text-transform-none align-middle">Chỉ áp dụng mua online</small>
          </h2>
        </div>
        <div className="col-md-3 col-sm-4 text-center text-sm-right">
          {/* <a className="btn btn-light btn-white btn-lg" href="category.html">Xem giảm giá</a> */}
        </div>
      </div>
    </div>
                    {/* <FeaturedCategory/> */}
